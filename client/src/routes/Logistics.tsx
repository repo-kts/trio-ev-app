...
export function Logistics() {
    return (
        ...
        >
            ...
            <section className="py-16 md:py-20 px-5 md:px-6 bg-secondary/10 border-y border-white/5 relative overflow-hidden">
                <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-8 md:gap-12">
                    <div className="flex-1 space-y-6 w-full">
                        <div className="md:hidden flex items-center gap-2">
                            <span className="w-1.5 h-1.5 rounded-full bg-accent animate-pulse" />
                            <span className="text-[10px] uppercase tracking-[0.25em] text-accent font-bold">Coverage Map</span>
                        </div>
                        <div>
                            <h2 className="font-heading text-[2rem] md:text-4xl font-bold uppercase mb-3 md:mb-4 text-textPrimary leading-[0.95]">
                                Nationwide <span className="text-accent">Fleet Coverage.</span>
                            </h2>
                            <p className="text-textPrimary/60 text-sm md:text-lg leading-relaxed">
                                Real-time visualization of our intelligent EV logistics infrastructure across major Indian economic hubs.
                            </p>
                        </div>
                    </div>
                    <div className="flex-1 relative w-full max-w-md aspect-square bg-secondary/30 rounded-3xl md:rounded-[2.5rem] border border-white/10 flex items-center justify-center overflow-hidden">
                        <IndiaFleetMap />
                    </div>
                </div>
            </section>
