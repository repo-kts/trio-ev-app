            ...
            <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 md:px-12 w-full">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-4">
                        <button className="w-full sm:w-auto px-7 sm:px-8 py-3.5 sm:py-4 bg-accent text-background font-bold uppercase tracking-widest rounded-full hover:bg-accent/90 transition-all text-[11px] sm:text-xs shadow-[0_15px_30px_rgba(92,240,158,0.2)]">
                            Deploy Smart Fleet
                        </button>
                        <button className="w-full sm:w-auto px-7 sm:px-8 py-3.5 sm:py-4 bg-white/5 border border-white/10 text-textPrimary font-bold uppercase tracking-widest rounded-full hover:bg-white/10 transition-all text-[11px] sm:text-xs">
                            View Simulation
                        </button>
                    </div>
                </motion.div>
